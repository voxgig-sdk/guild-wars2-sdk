...
class GuildWars2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GuildWars2TestRunner.getenv("GUILDWARS2_TEST_LIVE")
        override = GuildWars2TestRunner.getenv("GUILDWARS2_TEST_OVERRIDE")
        ...
        explain = GuildWars2TestRunner.getenv("GUILDWARS2_TEST_EXPLAIN")
        if explain is not None and explain != "":
            m["GUILDWARS2_TEST_EXPLAIN"] = explain
