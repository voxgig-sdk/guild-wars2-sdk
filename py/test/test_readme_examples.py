# GuildWars2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GuildWars2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GuildWars2SDK(...) and GuildWars2SDK.test(...) become
#      GuildWars2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "guildwars2_sdk"
_SDK_CLASS = "GuildWars2SDK"
...
_ENTITIES = {
    ...
    "Guild": "guild",
    "GuildAuthenticated": "guild_authenticated",
    "HomeInstance": "home_instance",
    "Item": "item",
    "Map": "map",
    "MapInformation": "map_information",
    "Miscellaneous": "miscellaneous",
    "Story": "story",
    "StructuredPvP": "structured_pv_p",
    "TradingPost": "trading_post",
    "WorldVsWorld": "world_vs_world",
}
