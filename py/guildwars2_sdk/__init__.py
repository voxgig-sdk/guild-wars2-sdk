...
from guildwars2_sdk.utility import register

# Load features
from guildwars2_sdk.feature.base_feature import GuildWars2BaseFeature
from guildwars2_sdk.features import _has_feature, _make_feature
...
class GuildWars2SDK:
    ...
    def __init__(self, options=None):
        ...
        from guildwars2_sdk.config import shared_config
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "GuildWars2SDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("GuildWars2SDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Achievement(self, data=None) -> "AchievementEntity":
        ...
        from guildwars2_sdk.entity.achievement_entity import AchievementEntity
    ...
    def Authenticated(self, data=None) -> "AuthenticatedEntity":
        ...
        from guildwars2_sdk.entity.authenticated_entity import AuthenticatedEntity
    ...
    def DailyReward(self, data=None) -> "DailyRewardEntity":
        ...
        from guildwars2_sdk.entity.daily_reward_entity import DailyRewardEntity
    ...
    def GameMechanic(self, data=None) -> "GameMechanicEntity":
        ...
        from guildwars2_sdk.entity.game_mechanic_entity import GameMechanicEntity
    ...
    def Guild(self, data=None) -> "GuildEntity":
        ...
        from guildwars2_sdk.entity.guild_entity import GuildEntity
    ...
    def GuildAuthenticated(self, data=None) -> "GuildAuthenticatedEntity":
        ...
        from guildwars2_sdk.entity.guild_authenticated_entity import GuildAuthenticatedEntity
    ...
    def MapInformation(self, data=None) -> "MapInformationEntity":
        ...
        from guildwars2_sdk.entity.map_information_entity import MapInformationEntity
    ...
    def Miscellaneous(self, data=None) -> "MiscellaneousEntity":
        ...
        from guildwars2_sdk.entity.miscellaneous_entity import MiscellaneousEntity
    ...
    def Story(self, data=None) -> "StoryEntity":
        ...
        from guildwars2_sdk.entity.story_entity import StoryEntity
    ...
    def StructuredPvP(self, data=None) -> "StructuredPvPEntity":
        ...
        from guildwars2_sdk.entity.structured_pv_p_entity import StructuredPvPEntity
    ...
    def TradingPost(self, data=None) -> "TradingPostEntity":
        ...
        from guildwars2_sdk.entity.trading_post_entity import TradingPostEntity
    ...
    def WorldVsWorld(self, data=None) -> "WorldVsWorldEntity":
        ...
        from guildwars2_sdk.entity.world_vs_world_entity import WorldVsWorldEntity
        return WorldVsWorldEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "GuildWars2SDK":
        if sdkopts is None:
            sdkopts = {}
