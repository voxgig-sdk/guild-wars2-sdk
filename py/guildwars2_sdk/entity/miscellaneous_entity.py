...
class MiscellaneousEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MiscellaneousEntity(self._client, opts)
    ...
    def data_get(self) -> Miscellaneous:
    ...
    def match_get(self) -> Miscellaneous:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Miscellaneous:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Miscellaneous().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Miscellaneous]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Miscellaneous().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
