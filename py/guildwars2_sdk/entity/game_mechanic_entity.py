...
class GameMechanicEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GameMechanicEntity(self._client, opts)
    ...
    def data_get(self) -> GameMechanic:
    ...
    def match_get(self) -> GameMechanic:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GameMechanic]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GameMechanic().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
