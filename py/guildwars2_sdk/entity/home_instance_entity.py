...
class HomeInstanceEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HomeInstanceEntity(self._client, opts)
    ...
    def data_get(self) -> HomeInstance:
    ...
    def match_get(self) -> HomeInstance:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HomeInstance]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HomeInstance().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
