...
class MapInformationEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return MapInformationEntity(self._client, opts)
    ...
    def data_get(self) -> MapInformation:
    ...
    def match_get(self) -> MapInformation:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[MapInformation]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.MapInformation().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
