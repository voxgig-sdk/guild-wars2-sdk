...
class GuildAuthenticatedEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GuildAuthenticatedEntity(self._client, opts)
    ...
    def data_get(self) -> GuildAuthenticated:
    ...
    def match_get(self) -> GuildAuthenticated:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[GuildAuthenticated]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.GuildAuthenticated().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
