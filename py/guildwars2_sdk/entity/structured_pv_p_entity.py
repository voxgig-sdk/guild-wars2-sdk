...
class StructuredPvPEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return StructuredPvPEntity(self._client, opts)
    ...
    def data_get(self) -> StructuredPvP:
    ...
    def match_get(self) -> StructuredPvP:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[StructuredPvP]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.StructuredPvP().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
