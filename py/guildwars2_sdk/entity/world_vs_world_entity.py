...
class WorldVsWorldEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WorldVsWorldEntity(self._client, opts)
    ...
    def data_get(self) -> WorldVsWorld:
    ...
    def match_get(self) -> WorldVsWorld:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[WorldVsWorld]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.WorldVsWorld().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
