...
class HomeInstanceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GUILDWARS__TEST_HOME_INSTANCE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def home_instance_basic_setup(extra)
  ...
  entid_env_raw = ENV["GUILDWARS__TEST_HOME_INSTANCE_ENTID"]
