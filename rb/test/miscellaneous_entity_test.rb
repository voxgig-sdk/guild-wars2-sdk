...
class MiscellaneousEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set GUILDWARS__TEST_MISCELLANEOUS_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def miscellaneous_basic_setup(extra)
  ...
  entid_env_raw = ENV["GUILDWARS__TEST_MISCELLANEOUS_ENTID"]
