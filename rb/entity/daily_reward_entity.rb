...
class DailyRewardEntity
  ...
  def make
    opts = @_entopts.dup
    DailyRewardEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [DailyRewardListMatch, Hash, nil] match filter (any subset of
  #   DailyReward fields); defaults to nil, treated as an empty match that lists all.
