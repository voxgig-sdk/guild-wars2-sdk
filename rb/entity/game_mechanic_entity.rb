...
class GameMechanicEntity
  ...
  def make
    opts = @_entopts.dup
    GameMechanicEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GameMechanicListMatch, Hash, nil] match filter (any subset of
  #   GameMechanic fields); defaults to nil, treated as an empty match that lists all.
