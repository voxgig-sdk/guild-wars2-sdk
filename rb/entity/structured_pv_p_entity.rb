...
class StructuredPvPEntity
  ...
  def make
    opts = @_entopts.dup
    StructuredPvPEntity.new(@_client, opts)
  end
  ...
  # @return [StructuredPvP, Hash] the current StructuredPvP data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of StructuredPvP fields)
  def match_get
  ...
  #
  # @param reqmatch [StructuredPvPListMatch, Hash, nil] match filter (any subset of
  #   StructuredPvP fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<StructuredPvP>, Array] the matching StructuredPvP items; raises GuildWars2Error on failure
