...
class WorldVsWorldEntity
  ...
  def make
    opts = @_entopts.dup
    WorldVsWorldEntity.new(@_client, opts)
  end
  ...
  # @return [WorldVsWorld, Hash] the current WorldVsWorld data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of WorldVsWorld fields)
  def match_get
  ...
  #
  # @param reqmatch [WorldVsWorldListMatch, Hash, nil] match filter (any subset of
  #   WorldVsWorld fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<WorldVsWorld>, Array] the matching WorldVsWorld items; raises GuildWars2Error on failure
