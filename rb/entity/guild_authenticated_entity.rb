...
class GuildAuthenticatedEntity
  ...
  def make
    opts = @_entopts.dup
    GuildAuthenticatedEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [GuildAuthenticatedListMatch, Hash, nil] match filter (any subset of
  #   GuildAuthenticated fields); defaults to nil, treated as an empty match that lists all.
