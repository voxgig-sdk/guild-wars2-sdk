...
class HomeInstanceEntity
  ...
  def make
    opts = @_entopts.dup
    HomeInstanceEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [HomeInstanceListMatch, Hash, nil] match filter (any subset of
  #   HomeInstance fields); defaults to nil, treated as an empty match that lists all.
