...
class MapInformationEntity
  ...
  def make
    opts = @_entopts.dup
    MapInformationEntity.new(@_client, opts)
  end
  ...
  # @return [MapInformation, Hash] the current MapInformation data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of MapInformation fields)
  def match_get
  ...
  #
  # @param reqmatch [MapInformationListMatch, Hash, nil] match filter (any subset of
  #   MapInformation fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<MapInformation>, Array] the matching MapInformation items; raises GuildWars2Error on failure
