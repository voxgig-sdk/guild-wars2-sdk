...
local StructuredPvPEntity = {}
StructuredPvPEntity.__index = StructuredPvPEntity


function StructuredPvPEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, StructuredPvPEntity)
  self._name = "structured_pv_p"
  self._client = client
...
function StructuredPvPEntity:get_name()
  return self._name
end


function StructuredPvPEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return StructuredPvPEntity.new(self._client, opts)
end
...
function StructuredPvPEntity:mark_deleted()
  self._deleted = true
end


function StructuredPvPEntity:deleted()
  return true == self._deleted
end


function StructuredPvPEntity:data_set(args)
  if args ~= nil then
...
function StructuredPvPEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function StructuredPvPEntity:match_set(args)
  if args ~= nil then
...
function StructuredPvPEntity:match_get()
...
function StructuredPvPEntity:stream(action, args, callopts)
...
function StructuredPvPEntity:_run_op(ctx, post_done)
  local utility = self._utility
