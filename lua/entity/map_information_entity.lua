...
local MapInformationEntity = {}
MapInformationEntity.__index = MapInformationEntity


function MapInformationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MapInformationEntity)
  self._name = "map_information"
  self._client = client
...
function MapInformationEntity:get_name()
  return self._name
end


function MapInformationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MapInformationEntity.new(self._client, opts)
end
...
function MapInformationEntity:mark_deleted()
  self._deleted = true
end


function MapInformationEntity:deleted()
  return true == self._deleted
end


function MapInformationEntity:data_set(args)
  if args ~= nil then
...
function MapInformationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MapInformationEntity:match_set(args)
  if args ~= nil then
...
function MapInformationEntity:match_get()
...
function MapInformationEntity:stream(action, args, callopts)
...
---@param reqmatch MapInformationListMatch
---@param ctrl? table
---@return MapInformation[]
---@return string? err
function MapInformationEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function MapInformationEntity:_run_op(ctx, post_done)
  local utility = self._utility
