...
local MiscellaneousEntity = {}
MiscellaneousEntity.__index = MiscellaneousEntity


function MiscellaneousEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MiscellaneousEntity)
  self._name = "miscellaneous"
  self._client = client
...
function MiscellaneousEntity:get_name()
  return self._name
end


function MiscellaneousEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MiscellaneousEntity.new(self._client, opts)
end
...
function MiscellaneousEntity:mark_deleted()
  self._deleted = true
end


function MiscellaneousEntity:deleted()
  return true == self._deleted
end


function MiscellaneousEntity:data_set(args)
  if args ~= nil then
...
function MiscellaneousEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MiscellaneousEntity:match_set(args)
  if args ~= nil then
...
function MiscellaneousEntity:match_get()
...
function MiscellaneousEntity:stream(action, args, callopts)
...
---@param reqmatch MiscellaneousLoadMatch
---@param ctrl? table
---@return Miscellaneous
---@return string? err
function MiscellaneousEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MiscellaneousListMatch
---@param ctrl? table
---@return Miscellaneous[]
---@return string? err
function MiscellaneousEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function MiscellaneousEntity:_run_op(ctx, post_done)
  local utility = self._utility
