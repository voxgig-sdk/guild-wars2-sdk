...
-- by passing it.
function GuildWars2SDK:_raw_request(fetchargs)
  local utility = self._utility
...
function GuildWars2SDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "GuildWars2SDK: graphql: " .. msg
    res.graphql = errors
  end
