...
describe("MapInformationDirect", function()
  it("should direct-list-map_information", function()
    local setup = map_information_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-map_information", setup.live and "live" or "unit")
...
function map_information_direct_setup(mockres)
