...
describe("StructuredPvPDirect", function()
  it("should direct-list-structured_pv_p", function()
    local setup = structured_pv_p_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-structured_pv_p", setup.live and "live" or "unit")
...
function structured_pv_p_direct_setup(mockres)
