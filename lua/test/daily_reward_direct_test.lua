...
describe("DailyRewardDirect", function()
  it("should direct-list-daily_reward", function()
    local setup = daily_reward_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-daily_reward", setup.live and "live" or "unit")
...
function daily_reward_direct_setup(mockres)
