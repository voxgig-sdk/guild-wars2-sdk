...
function runner.env_override(m)
  local live = runner.getenv("GUILD_WARS2_TEST_LIVE")
  local override = runner.getenv("GUILD_WARS2_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GUILD_WARS2_TEST_EXPLAIN")
