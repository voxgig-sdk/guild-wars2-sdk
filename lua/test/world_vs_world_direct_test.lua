...
describe("WorldVsWorldDirect", function()
  it("should direct-list-world_vs_world", function()
    local setup = world_vs_world_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-world_vs_world", setup.live and "live" or "unit")
...
function world_vs_world_direct_setup(mockres)
