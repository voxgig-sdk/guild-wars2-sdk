...
describe("MiscellaneousDirect", function()
  it("should direct-list-miscellaneous", function()
    local setup = miscellaneous_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-miscellaneous", setup.live and "live" or "unit")
  ...
  it("should direct-load-miscellaneous", function()
    local setup = miscellaneous_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-miscellaneous", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function miscellaneous_direct_setup(mockres)
