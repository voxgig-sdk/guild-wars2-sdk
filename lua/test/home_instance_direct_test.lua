...
describe("HomeInstanceDirect", function()
  it("should direct-list-home_instance", function()
    local setup = home_instance_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-home_instance", setup.live and "live" or "unit")
...
function home_instance_direct_setup(mockres)
