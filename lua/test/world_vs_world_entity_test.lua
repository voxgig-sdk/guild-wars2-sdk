...
describe("WorldVsWorldEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set GUILD_WARS2_TEST_WORLD_VS_WORLD_ENTID JSON to run live")
      return
    end
...
function world_vs_world_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("GUILD_WARS2_TEST_WORLD_VS_WORLD_ENTID")
