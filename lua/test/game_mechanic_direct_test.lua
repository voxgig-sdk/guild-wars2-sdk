...
describe("GameMechanicDirect", function()
  it("should direct-list-game_mechanic", function()
    local setup = game_mechanic_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-game_mechanic", setup.live and "live" or "unit")
...
function game_mechanic_direct_setup(mockres)
