...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.GUILDWARS2_TEST_LIVE ||
    'TRUE' === process.env.GUILDWARS2_TEST_OVERRIDE
  ) {
  ...
  m.GUILDWARS2_TEST_EXPLAIN = process.env.GUILDWARS2_TEST_EXPLAIN || m.GUILDWARS2_TEST_EXPLAIN
