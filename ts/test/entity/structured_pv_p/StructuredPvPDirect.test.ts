...
describe('StructuredPvPDirect', async () => {
  ...
  test('direct-list-structured_pv_p', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-structured_pv_p', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GUILD_WARS2_TEST_STRUCTURED_PV_P_ENTID']
