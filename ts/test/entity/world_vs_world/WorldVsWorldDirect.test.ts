...
describe('WorldVsWorldDirect', async () => {
  ...
  test('direct-list-world_vs_world', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-world_vs_world', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GUILD_WARS2_TEST_WORLD_VS_WORLD_ENTID']
