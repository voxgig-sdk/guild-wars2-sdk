...
describe('HomeInstanceDirect', async () => {
  ...
  test('direct-list-home_instance', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-home_instance', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GUILD_WARS2_TEST_HOME_INSTANCE_ENTID']
