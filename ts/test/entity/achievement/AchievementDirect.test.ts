...
describe('AchievementDirect', async () => {
  ...
  test('direct-load-achievement', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-achievement', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GUILD_WARS2_TEST_ACHIEVEMENT_ENTID']
