...
describe('GameMechanicDirect', async () => {
  ...
  test('direct-list-game_mechanic', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-game_mechanic', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['GUILD_WARS2_TEST_GAME_MECHANIC_ENTID']
