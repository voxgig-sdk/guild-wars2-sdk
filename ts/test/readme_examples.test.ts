...
//     (\`new GuildWars2SDK(...)\` / \`GuildWars2SDK.test(...)\` become
//     \`GuildWars2SDK.test({ entity: ... })\`), transpiled to JS, and run
...
const TEST_SEED = {"entity":{"achievement":{"test01":{"id":"test01"}},"authenticated":{"test01":{"id":"test01"}},"daily_reward":{"test01":{"id":"test01"}},"game_mechanic":{"test01":{"id":"test01"}},"guild":{"test01":{"id":"test01"}},"guild_authenticated":{"test01":{"id":"test01"}},"home_instance":{"test01":{"id":"test01"}},"item":{"test01":{"id":"test01"}},"map":{"test01":{"id":"test01"}},"map_information":{"test01":{"id":"test01"}},"miscellaneous":{"test01":{"id":"test01"}},"story":{"test01":{"id":"test01"}},"structured_pv_p":{"test01":{"id":"test01"}},"trading_post":{"test01":{"id":"test01"}},"world_vs_world":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new GuildWars2SDK(...)\` and any
// \`GuildWars2SDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+GuildWars2SDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/GuildWars2SDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
