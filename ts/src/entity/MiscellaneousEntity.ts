...
class MiscellaneousEntity extends GuildWars2EntityBase<Miscellaneous> {
  ...
  make(this: MiscellaneousEntity) {
    return new MiscellaneousEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: MiscellaneousLoadMatch, ctrl?: Control): Promise<MiscellaneousEntity> {
  ...
  async list(this: any, reqmatch?: MiscellaneousListMatch, ctrl?: Control): Promise<MiscellaneousEntity[]> {
