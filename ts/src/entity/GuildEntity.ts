...
class GuildEntity extends GuildWars2EntityBase<Guild> {
  ...
  make(this: GuildEntity) {
    return new GuildEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: GuildLoadMatch, ctrl?: Control): Promise<GuildEntity> {
  ...
  async list(this: any, reqmatch?: GuildListMatch, ctrl?: Control): Promise<GuildEntity[]> {
