...
function envOverride(m) {
    if ('TRUE' === process.env.GUILD_WARS2_TEST_LIVE ||
        'TRUE' === process.env.GUILD_WARS2_TEST_OVERRIDE) {
    ...
    m.GUILD_WARS2_TEST_EXPLAIN = process.env.GUILD_WARS2_TEST_EXPLAIN || m.GUILD_WARS2_TEST_EXPLAIN;
    return m;
}
