...
(0, node_test_1.describe)('MapInformationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-map_information', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-map_information', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_MAP_INFORMATION_ENTID'];
...
//# sourceMappingURL=MapInformationDirect.test.js.map