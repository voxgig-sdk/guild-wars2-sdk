...
(0, node_test_1.describe)('GuildEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'guild.' + op, live))
                return;
        }
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GUILD_WARS2_TEST_GUILD_ENTID JSON to run live');
            return;
        }
        ...
        const guild_ref01_match = {};
        const guild_ref01_list = (await guild_ref01_ent.list(guild_ref01_match)).map((e) => e.data());
        // LOAD
        ...
        (0, node_assert_1.default)(guild_ref01_data_dt0.id === guild_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GUILD_WARS2_TEST_GUILD_ENTID'];
    ...
    idmap = env['GUILD_WARS2_TEST_GUILD_ENTID'];
