...
(0, node_test_1.describe)('GuildDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-guild', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-guild', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-guild', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-guild', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_GUILD_ENTID'];
...
//# sourceMappingURL=GuildDirect.test.js.map