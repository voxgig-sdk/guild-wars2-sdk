...
(0, node_test_1.describe)('AchievementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-achievement', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-achievement', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GUILD_WARS2_TEST_ACHIEVEMENT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_ACHIEVEMENT_ENTID'];
