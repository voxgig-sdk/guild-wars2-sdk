...
(0, node_test_1.describe)('MapEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GUILD_WARS2_TEST_MAP_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GUILD_WARS2_TEST_MAP_ENTID'];
    const idmapOverridden = null != idmapEnvVal && idmapEnvVal.trim().startsWith('{');
    const env = (0, utility_1.envOverride)({
        'GUILD_WARS2_TEST_MAP_ENTID': idmap,
        'GUILD_WARS2_TEST_LIVE': 'FALSE',
        'GUILD_WARS2_TEST_EXPLAIN': 'FALSE',
        'GUILD_WARS2_APIKEY': '',
    });
    idmap = env['GUILD_WARS2_TEST_MAP_ENTID'];
