...
(0, node_test_1.describe)('DailyRewardDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-daily_reward', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-daily_reward', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_DAILY_REWARD_ENTID'];
...
//# sourceMappingURL=DailyRewardDirect.test.js.map