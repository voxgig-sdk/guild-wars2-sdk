...
(0, node_test_1.describe)('AuthenticatedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-authenticated', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-authenticated', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-authenticated', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-authenticated', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_AUTHENTICATED_ENTID'];
...
//# sourceMappingURL=AuthenticatedDirect.test.js.map