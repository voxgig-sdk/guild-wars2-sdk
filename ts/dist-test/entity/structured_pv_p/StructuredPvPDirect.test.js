...
(0, node_test_1.describe)('StructuredPvPDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-structured_pv_p', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-structured_pv_p', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_STRUCTURED_PV_P_ENTID'];
...
//# sourceMappingURL=StructuredPvPDirect.test.js.map