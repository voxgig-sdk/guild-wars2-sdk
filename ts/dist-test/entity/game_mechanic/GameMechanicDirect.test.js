...
(0, node_test_1.describe)('GameMechanicDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-game_mechanic', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-game_mechanic', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_GAME_MECHANIC_ENTID'];
...
//# sourceMappingURL=GameMechanicDirect.test.js.map