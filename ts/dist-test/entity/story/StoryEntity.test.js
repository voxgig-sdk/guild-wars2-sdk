...
(0, node_test_1.describe)('StoryEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set GUILD_WARS2_TEST_STORY_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['GUILD_WARS2_TEST_STORY_ENTID'];
    ...
    idmap = env['GUILD_WARS2_TEST_STORY_ENTID'];
