...
(0, node_test_1.describe)('WorldVsWorldDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-world_vs_world', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-world_vs_world', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GUILD_WARS2_TEST_WORLD_VS_WORLD_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_WORLD_VS_WORLD_ENTID'];
...
//# sourceMappingURL=WorldVsWorldDirect.test.js.map