...
(0, node_test_1.describe)('TradingPostDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.GuildWars2SDK({
    ...
    (0, node_test_1.test)('direct-load-trading_post', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-trading_post', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-trading_post', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-trading_post', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'GUILD_WARS2_TEST_TRADING_POST_ENTID': {},
    ...
    if (live) {
        ...
        const client = new __1.GuildWars2SDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {
            apikey: env.GUILD_WARS2_APIKEY,
        }));
        let idmap = env['GUILD_WARS2_TEST_TRADING_POST_ENTID'];
    ...
    const client = new __1.GuildWars2SDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TradingPostDirect.test.js.map