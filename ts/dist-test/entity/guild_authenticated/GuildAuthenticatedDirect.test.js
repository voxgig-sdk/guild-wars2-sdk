...
(0, node_test_1.describe)('GuildAuthenticatedDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-guild_authenticated', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-guild_authenticated', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["guild_authenticated01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_GUILD_AUTHENTICATED_ENTID'];
...
//# sourceMappingURL=GuildAuthenticatedDirect.test.js.map