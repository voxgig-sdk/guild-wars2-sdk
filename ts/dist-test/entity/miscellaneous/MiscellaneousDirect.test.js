...
(0, node_test_1.describe)('MiscellaneousDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-miscellaneous', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-miscellaneous', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-miscellaneous', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-miscellaneous', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_MISCELLANEOUS_ENTID'];
...
//# sourceMappingURL=MiscellaneousDirect.test.js.map