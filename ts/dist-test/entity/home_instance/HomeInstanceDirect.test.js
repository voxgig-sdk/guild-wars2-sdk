...
(0, node_test_1.describe)('HomeInstanceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-home_instance', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-home_instance', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['GUILD_WARS2_TEST_HOME_INSTANCE_ENTID'];
...
//# sourceMappingURL=HomeInstanceDirect.test.js.map