...
const testSeed = `map[string]any{"entity": map[string]any{"achievement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authenticated": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "daily_reward": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game_mechanic": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "guild": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "guild_authenticated": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "home_instance": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map_information": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "miscellaneous": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "story": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "structured_pv_p": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "trading_post": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "world_vs_world": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
