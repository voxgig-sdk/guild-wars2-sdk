...
// instead of `sdk.NewGuildWars2SDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *GuildWars2SDK  { return NewGuildWars2SDK(nil) }
func Test() *GuildWars2SDK { return TestSDK(nil, nil) }
