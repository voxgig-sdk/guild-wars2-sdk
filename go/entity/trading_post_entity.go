...
func NewTradingPostEntity(client *core.GuildWars2SDK, entopts map[string]any) *TradingPostEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TradingPostEntity) GetName() string { return e.name }
...
func (e *TradingPostEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TradingPostEntity) Deleted() bool {
	return e.deleted
}


func (e *TradingPostEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTradingPostEntity(e.client, opts)
}

func (e *TradingPostEntity) Data(args ...any) any {
...
func (e *TradingPostEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TradingPost; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TradingPostEntity) DataTyped(data ...TradingPost) TradingPost {
	if len(data) > 0 {
		return typedFrom[TradingPost](e.Data(asMap(data[0])))
	}
	return typedFrom[TradingPost](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TradingPost (all fields
// optional at the wire level).
func (e *TradingPostEntity) MatchTyped(match ...TradingPost) TradingPost {
	if len(match) > 0 {
		return typedFrom[TradingPost](e.Match(asMap(match[0])))
	}
	return typedFrom[TradingPost](e.Match())
}
...
func (e *TradingPostEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TradingPostEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TradingPostLoadMatch and returns an TradingPost. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TradingPostEntity) LoadTyped(reqmatch TradingPostLoadMatch, ctrl map[string]any) (TradingPost, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return TradingPost{}, err
	}
	return typedFrom[TradingPost](res), nil
}




func (e *TradingPostEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TradingPostListMatch and returns []TradingPost. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TradingPostEntity) ListTyped(reqmatch TradingPostListMatch, ctrl map[string]any) ([]TradingPost, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TradingPost](res), nil
}



func (e *TradingPostEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TradingPostEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TradingPostEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TradingPostEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
