...
func NewDailyRewardEntity(client *core.GuildWars2SDK, entopts map[string]any) *DailyRewardEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DailyRewardEntity) GetName() string { return e.name }
...
func (e *DailyRewardEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DailyRewardEntity) Deleted() bool {
	return e.deleted
}


func (e *DailyRewardEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDailyRewardEntity(e.client, opts)
}

func (e *DailyRewardEntity) Data(args ...any) any {
...
func (e *DailyRewardEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an DailyReward; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DailyRewardEntity) DataTyped(data ...DailyReward) DailyReward {
	if len(data) > 0 {
		return typedFrom[DailyReward](e.Data(asMap(data[0])))
	}
	return typedFrom[DailyReward](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through DailyReward (all fields
// optional at the wire level).
func (e *DailyRewardEntity) MatchTyped(match ...DailyReward) DailyReward {
	if len(match) > 0 {
		return typedFrom[DailyReward](e.Match(asMap(match[0])))
	}
	return typedFrom[DailyReward](e.Match())
}
...
func (e *DailyRewardEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DailyRewardEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *DailyRewardEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DailyRewardListMatch and returns []DailyReward. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *DailyRewardEntity) ListTyped(reqmatch DailyRewardListMatch, ctrl map[string]any) ([]DailyReward, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[DailyReward](res), nil
}



func (e *DailyRewardEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DailyRewardEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DailyRewardEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DailyRewardEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
