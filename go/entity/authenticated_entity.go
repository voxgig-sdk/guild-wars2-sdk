...
func NewAuthenticatedEntity(client *core.GuildWars2SDK, entopts map[string]any) *AuthenticatedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AuthenticatedEntity) GetName() string { return e.name }
...
func (e *AuthenticatedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AuthenticatedEntity) Deleted() bool {
	return e.deleted
}


func (e *AuthenticatedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAuthenticatedEntity(e.client, opts)
}

func (e *AuthenticatedEntity) Data(args ...any) any {
...
func (e *AuthenticatedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Authenticated; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AuthenticatedEntity) DataTyped(data ...Authenticated) Authenticated {
	if len(data) > 0 {
		return typedFrom[Authenticated](e.Data(asMap(data[0])))
	}
	return typedFrom[Authenticated](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Authenticated (all fields
// optional at the wire level).
func (e *AuthenticatedEntity) MatchTyped(match ...Authenticated) Authenticated {
	if len(match) > 0 {
		return typedFrom[Authenticated](e.Match(asMap(match[0])))
	}
	return typedFrom[Authenticated](e.Match())
}
...
func (e *AuthenticatedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AuthenticatedEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AuthenticatedLoadMatch and returns an Authenticated. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AuthenticatedEntity) LoadTyped(reqmatch AuthenticatedLoadMatch, ctrl map[string]any) (Authenticated, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Authenticated{}, err
	}
	return typedFrom[Authenticated](res), nil
}




func (e *AuthenticatedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AuthenticatedListMatch and returns []Authenticated. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AuthenticatedEntity) ListTyped(reqmatch AuthenticatedListMatch, ctrl map[string]any) ([]Authenticated, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Authenticated](res), nil
}



func (e *AuthenticatedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AuthenticatedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AuthenticatedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AuthenticatedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
