...
func NewGuildEntity(client *core.GuildWars2SDK, entopts map[string]any) *GuildEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GuildEntity) GetName() string { return e.name }
...
func (e *GuildEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GuildEntity) Deleted() bool {
	return e.deleted
}


func (e *GuildEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGuildEntity(e.client, opts)
}

func (e *GuildEntity) Data(args ...any) any {
...
func (e *GuildEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GuildEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GuildEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// GuildListMatch and returns []Guild. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GuildEntity) ListTyped(reqmatch GuildListMatch, ctrl map[string]any) ([]Guild, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Guild](res), nil
}



func (e *GuildEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GuildEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GuildEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GuildEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
