...
type GameMechanicEntity struct {
	name    string
...
func NewGameMechanicEntity(client *core.GuildWars2SDK, entopts map[string]any) *GameMechanicEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GameMechanicEntity) GetName() string { return e.name }
...
func (e *GameMechanicEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GameMechanicEntity) Deleted() bool {
	return e.deleted
}


func (e *GameMechanicEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGameMechanicEntity(e.client, opts)
}

func (e *GameMechanicEntity) Data(args ...any) any {
...
func (e *GameMechanicEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GameMechanic; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GameMechanicEntity) DataTyped(data ...GameMechanic) GameMechanic {
	if len(data) > 0 {
		return typedFrom[GameMechanic](e.Data(asMap(data[0])))
	}
	return typedFrom[GameMechanic](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GameMechanic (all fields
// optional at the wire level).
func (e *GameMechanicEntity) MatchTyped(match ...GameMechanic) GameMechanic {
	if len(match) > 0 {
		return typedFrom[GameMechanic](e.Match(asMap(match[0])))
	}
	return typedFrom[GameMechanic](e.Match())
}
...
func (e *GameMechanicEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GameMechanicEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GameMechanicEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GameMechanicListMatch and returns []GameMechanic. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GameMechanicEntity) ListTyped(reqmatch GameMechanicListMatch, ctrl map[string]any) ([]GameMechanic, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GameMechanic](res), nil
}



func (e *GameMechanicEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GameMechanicEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GameMechanicEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GameMechanicEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
