...
type HomeInstanceEntity struct {
	name    string
...
func NewHomeInstanceEntity(client *core.GuildWars2SDK, entopts map[string]any) *HomeInstanceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HomeInstanceEntity) GetName() string { return e.name }
...
func (e *HomeInstanceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HomeInstanceEntity) Deleted() bool {
	return e.deleted
}


func (e *HomeInstanceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHomeInstanceEntity(e.client, opts)
}

func (e *HomeInstanceEntity) Data(args ...any) any {
...
func (e *HomeInstanceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an HomeInstance; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HomeInstanceEntity) DataTyped(data ...HomeInstance) HomeInstance {
	if len(data) > 0 {
		return typedFrom[HomeInstance](e.Data(asMap(data[0])))
	}
	return typedFrom[HomeInstance](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through HomeInstance (all fields
// optional at the wire level).
func (e *HomeInstanceEntity) MatchTyped(match ...HomeInstance) HomeInstance {
	if len(match) > 0 {
		return typedFrom[HomeInstance](e.Match(asMap(match[0])))
	}
	return typedFrom[HomeInstance](e.Match())
}
...
func (e *HomeInstanceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HomeInstanceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *HomeInstanceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HomeInstanceListMatch and returns []HomeInstance. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HomeInstanceEntity) ListTyped(reqmatch HomeInstanceListMatch, ctrl map[string]any) ([]HomeInstance, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[HomeInstance](res), nil
}



func (e *HomeInstanceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HomeInstanceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HomeInstanceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HomeInstanceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
