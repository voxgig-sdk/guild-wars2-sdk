...
type GuildAuthenticatedEntity struct {
	name    string
...
func NewGuildAuthenticatedEntity(client *core.GuildWars2SDK, entopts map[string]any) *GuildAuthenticatedEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GuildAuthenticatedEntity) GetName() string { return e.name }
...
func (e *GuildAuthenticatedEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GuildAuthenticatedEntity) Deleted() bool {
	return e.deleted
}


func (e *GuildAuthenticatedEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGuildAuthenticatedEntity(e.client, opts)
}

func (e *GuildAuthenticatedEntity) Data(args ...any) any {
...
func (e *GuildAuthenticatedEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GuildAuthenticated; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GuildAuthenticatedEntity) DataTyped(data ...GuildAuthenticated) GuildAuthenticated {
	if len(data) > 0 {
		return typedFrom[GuildAuthenticated](e.Data(asMap(data[0])))
	}
	return typedFrom[GuildAuthenticated](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GuildAuthenticated (all fields
// optional at the wire level).
func (e *GuildAuthenticatedEntity) MatchTyped(match ...GuildAuthenticated) GuildAuthenticated {
	if len(match) > 0 {
		return typedFrom[GuildAuthenticated](e.Match(asMap(match[0])))
	}
	return typedFrom[GuildAuthenticated](e.Match())
}
...
func (e *GuildAuthenticatedEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GuildAuthenticatedEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *GuildAuthenticatedEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GuildAuthenticatedListMatch and returns []GuildAuthenticated. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *GuildAuthenticatedEntity) ListTyped(reqmatch GuildAuthenticatedListMatch, ctrl map[string]any) ([]GuildAuthenticated, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[GuildAuthenticated](res), nil
}



func (e *GuildAuthenticatedEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GuildAuthenticatedEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GuildAuthenticatedEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GuildAuthenticatedEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
