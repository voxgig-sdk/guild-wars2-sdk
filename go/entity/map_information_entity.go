...
type MapInformationEntity struct {
	name    string
...
func NewMapInformationEntity(client *core.GuildWars2SDK, entopts map[string]any) *MapInformationEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MapInformationEntity) GetName() string { return e.name }
...
func (e *MapInformationEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MapInformationEntity) Deleted() bool {
	return e.deleted
}


func (e *MapInformationEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMapInformationEntity(e.client, opts)
}

func (e *MapInformationEntity) Data(args ...any) any {
...
func (e *MapInformationEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an MapInformation; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *MapInformationEntity) DataTyped(data ...MapInformation) MapInformation {
	if len(data) > 0 {
		return typedFrom[MapInformation](e.Data(asMap(data[0])))
	}
	return typedFrom[MapInformation](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through MapInformation (all fields
// optional at the wire level).
func (e *MapInformationEntity) MatchTyped(match ...MapInformation) MapInformation {
	if len(match) > 0 {
		return typedFrom[MapInformation](e.Match(asMap(match[0])))
	}
	return typedFrom[MapInformation](e.Match())
}
...
func (e *MapInformationEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MapInformationEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *MapInformationEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MapInformationListMatch and returns []MapInformation. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *MapInformationEntity) ListTyped(reqmatch MapInformationListMatch, ctrl map[string]any) ([]MapInformation, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[MapInformation](res), nil
}



func (e *MapInformationEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *MapInformationEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MapInformationEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MapInformationEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
