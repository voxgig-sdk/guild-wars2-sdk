...
type WorldVsWorldEntity struct {
	name    string
...
func NewWorldVsWorldEntity(client *core.GuildWars2SDK, entopts map[string]any) *WorldVsWorldEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WorldVsWorldEntity) GetName() string { return e.name }
...
func (e *WorldVsWorldEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WorldVsWorldEntity) Deleted() bool {
	return e.deleted
}


func (e *WorldVsWorldEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWorldVsWorldEntity(e.client, opts)
}

func (e *WorldVsWorldEntity) Data(args ...any) any {
...
func (e *WorldVsWorldEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *WorldVsWorldEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WorldVsWorldEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *WorldVsWorldEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WorldVsWorldEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WorldVsWorldEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WorldVsWorldEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
