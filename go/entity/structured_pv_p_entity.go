...
type StructuredPvPEntity struct {
	name    string
...
func NewStructuredPvPEntity(client *core.GuildWars2SDK, entopts map[string]any) *StructuredPvPEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StructuredPvPEntity) GetName() string { return e.name }
...
func (e *StructuredPvPEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StructuredPvPEntity) Deleted() bool {
	return e.deleted
}


func (e *StructuredPvPEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStructuredPvPEntity(e.client, opts)
}

func (e *StructuredPvPEntity) Data(args ...any) any {
...
func (e *StructuredPvPEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an StructuredPvP; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StructuredPvPEntity) DataTyped(data ...StructuredPvP) StructuredPvP {
	if len(data) > 0 {
		return typedFrom[StructuredPvP](e.Data(asMap(data[0])))
	}
	return typedFrom[StructuredPvP](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through StructuredPvP (all fields
// optional at the wire level).
func (e *StructuredPvPEntity) MatchTyped(match ...StructuredPvP) StructuredPvP {
	if len(match) > 0 {
		return typedFrom[StructuredPvP](e.Match(asMap(match[0])))
	}
	return typedFrom[StructuredPvP](e.Match())
}
...
func (e *StructuredPvPEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StructuredPvPEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *StructuredPvPEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StructuredPvPListMatch and returns []StructuredPvP. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StructuredPvPEntity) ListTyped(reqmatch StructuredPvPListMatch, ctrl map[string]any) ([]StructuredPvP, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[StructuredPvP](res), nil
}



func (e *StructuredPvPEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StructuredPvPEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StructuredPvPEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StructuredPvPEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
