...
The Golang SDK for the GuildWars2 API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/guild-wars2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/guild-wars2-sdk=../path/to/github.com/voxgig-sdk/guild-wars2-sdk
```
...
```
github.com/voxgig-sdk/guild-wars2-sdk/
...
The root package (`github.com/voxgig-sdk/guild-wars2-sdk`) re-exports everything needed
