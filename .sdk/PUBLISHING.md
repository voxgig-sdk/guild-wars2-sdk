...
|---|---|---|
| `ts/` | @voxgig-sdk/guild-wars2-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/guild-wars2-sdk \
      --repository voxgig-sdk/guild-wars2-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/guild-wars2-sdk` shows it, and
`npm trust revoke @voxgig-sdk/guild-wars2-sdk --id=<id>` removes it.
