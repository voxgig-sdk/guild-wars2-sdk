...
from projectname_sdk.core.control import GuildWars2Control
...
class GuildWars2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GuildWars2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GuildWars2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GuildWars2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GuildWars2Error(code, msg, self)
