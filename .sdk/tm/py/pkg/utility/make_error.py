# GuildWars2 SDK utility: make_error
...
def make_error_util(ctx, err):
    ...
    errmsg = ""
    if isinstance(err, GuildWars2Error):
        errmsg = err.msg
    ...
    msg = "GuildWars2SDK: " + opname + ": " + errmsg
    ...
    sdk_err = GuildWars2Error("", msg, ctx)
