...
from projectname_sdk import GuildWars2SDK
from projectname_sdk.core.spec import GuildWars2Spec
from projectname_sdk.core.result import GuildWars2Result
from projectname_sdk.core.response import GuildWars2Response
from projectname_sdk.core.operation import GuildWars2Operation
from projectname_sdk.core.error import GuildWars2Error
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import GuildWars2BaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return GuildWars2Error(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = GuildWars2SDK.test(None, None)
        ...
        class TestInitFeature(GuildWars2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(GuildWars2BaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = GuildWars2Spec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = GuildWars2SDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = GuildWars2SDK.test(None, setup_opts)
