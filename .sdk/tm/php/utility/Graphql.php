...
// GuildWars2 SDK utility: graphql
//
...
class GuildWars2Graphql
{
    ...
    // equivalent.
    public static function body(GuildWars2Context $ctx): mixed
    {
    ...
    public static function errors(GuildWars2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
