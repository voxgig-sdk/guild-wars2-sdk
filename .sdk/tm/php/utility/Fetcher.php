...
// GuildWars2 SDK utility: fetcher

class GuildWars2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GuildWars2SDK/1.0)';
    ...
    public static function call(GuildWars2Context $ctx, string $fullurl, array $fetchdef): array
    {
