...
// GuildWars2 SDK idempotency feature
...
class GuildWars2IdempotencyFeature extends GuildWars2BaseFeature
{
    ...
    private function _mutating(GuildWars2Context $ctx): bool
    {
