...
// GuildWars2 SDK timeout feature
...
class GuildWars2TimeoutFeature extends GuildWars2BaseFeature
{
    ...
    private function _with_timeout(GuildWars2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GuildWars2Context $_ctx, float $ms): void
    {
        $client = $this->client;
