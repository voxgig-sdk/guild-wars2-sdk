...
class GuildWars2NetsimFeature extends GuildWars2BaseFeature
{
    ...
    private function _simulate(GuildWars2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GuildWars2Context $ctx, array $applied): void
    {
        $client = $this->client;
