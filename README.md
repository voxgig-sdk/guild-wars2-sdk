...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/guild-wars2` | `npm install @voxgig-sdk/guild-wars2` |
| Python | `voxgig-sdk-guild-wars2` | `pip install voxgig-sdk-guild-wars2` |
| PHP | `voxgig-sdk/guild-wars2` | `composer require voxgig-sdk/guild-wars2` |
| Golang | `github.com/voxgig-sdk/guild-wars2-sdk/go` | `go get github.com/voxgig-sdk/guild-wars2-sdk/go` |
| Ruby | `voxgig-sdk-guild-wars2` | `gem install voxgig-sdk-guild-wars2` |
| Lua | `voxgig-sdk-guild-wars2` | `luarocks install voxgig-sdk-guild-wars2` |
