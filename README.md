...
This SDK exposes the API as a small set of **semantic entities** — Achievement, Authenticated, DailyReward, GameMechanic, Guild, GuildAuthenticated, HomeInstance, Item, Map, MapInformation, Miscellaneous, Story, StructuredPvP, TradingPost and WorldVsWorld — that you
