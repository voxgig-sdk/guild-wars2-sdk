...
func registerSDKWords(r *eng.Registry, client *sdk.GuildWars2SDK) {
...
func runOp(client *sdk.GuildWars2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
