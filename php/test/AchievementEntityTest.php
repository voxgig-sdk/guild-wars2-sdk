...
class AchievementEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set GUILDWARS__TEST_ACHIEVEMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function achievement_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("GUILDWARS__TEST_ACHIEVEMENT_ENTID");
