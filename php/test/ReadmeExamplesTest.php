...
// GuildWars2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GuildWars2SDK::test)
...
{
    private const SDK_CLASS = 'GuildWars2SDK';
    ...
    private const SDK_BASE = 'guildwars2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../guildwars2_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
