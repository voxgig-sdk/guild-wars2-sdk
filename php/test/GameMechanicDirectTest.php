...
class GameMechanicDirectTest extends TestCase
{
    public function test_direct_list_game_mechanic(): void
    {
        $setup = game_mechanic_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-game_mechanic", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
