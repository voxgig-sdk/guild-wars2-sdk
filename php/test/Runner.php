...
class GuildWars2TestRunner
{
    ...
    {
        $live = self::getenv('GUILD_WARS2_TEST_LIVE');
        $override = self::getenv('GUILD_WARS2_TEST_OVERRIDE');
        ...
        $explain = self::getenv('GUILD_WARS2_TEST_EXPLAIN');
...
class_alias('GuildWars2TestRunner', 'Runner');
class_alias('GuildWars2Helpers', 'Helpers');
