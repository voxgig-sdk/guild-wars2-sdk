...
class HomeInstanceDirectTest extends TestCase
{
    public function test_direct_list_home_instance(): void
    {
        $setup = home_instance_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-home_instance", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
