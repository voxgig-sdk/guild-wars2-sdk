...
// GuildWars2 SDK streaming feature
...
class GuildWars2StreamingFeature extends GuildWars2BaseFeature
{
    ...
    private function _iterate(GuildWars2Result $result): \Generator
    {
    ...
    private function _streamable(GuildWars2Context $ctx): bool
    {
