...
// GuildWars2 SDK ratelimit feature
...
class GuildWars2RatelimitFeature extends GuildWars2BaseFeature
{
    ...
    private function _acquire(GuildWars2Context $ctx): void
    {
    ...
    private function _track(GuildWars2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
