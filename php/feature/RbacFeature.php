...
class GuildWars2RbacFeature extends GuildWars2BaseFeature
{
    ...
    private function _required(GuildWars2Context $ctx): ?string
    {
    ...
    private function _reject(GuildWars2Context $ctx, string $required): void
    {
    ...
    private function _track(GuildWars2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
