...
class GuildWars2CacheFeature extends GuildWars2BaseFeature
{
    ...
    private function _through(GuildWars2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
