...
// GuildWars2 SDK telemetry feature
...
class GuildWars2TelemetryFeature extends GuildWars2BaseFeature
{
    ...
    private function _close(GuildWars2Context $ctx, bool $ok): void
    {
