...
// GuildWars2 SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GuildWars2TestFeature extends GuildWars2BaseFeature
{
    ...
    public function init(GuildWars2Context $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GuildWars2Context $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GuildWars2Param::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GuildWars2Context $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GuildWars2Context $ctx, $op, $args): array
    {
