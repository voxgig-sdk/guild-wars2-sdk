...
class GuildWars2ProxyFeature extends GuildWars2BaseFeature
{
    ...
    public function init(GuildWars2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GuildWars2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
