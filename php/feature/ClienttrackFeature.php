...
// GuildWars2 SDK clienttrack feature
...
class GuildWars2ClienttrackFeature extends GuildWars2BaseFeature
{
    ...
    public function PostConstruct(GuildWars2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GuildWars2-SDK';
