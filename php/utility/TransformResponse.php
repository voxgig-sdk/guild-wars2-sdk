...
// GuildWars2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class GuildWars2TransformResponse
{
    public static function call(GuildWars2Context $ctx): mixed
    {
        ...
        $transform = GuildWars2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
