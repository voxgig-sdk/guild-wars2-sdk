...
class GuildAuthenticatedEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "guild_authenticated";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GuildAuthenticatedEntity($this->_client, $opts);
    }

    /**
     * @param GuildAuthenticated|array $args GuildAuthenticated data (assoc-array) to store.
     */
    ...
    /**
     * @return GuildAuthenticated|array The current GuildAuthenticated data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GuildAuthenticated fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GuildAuthenticated fields).
     */
     ...
     *
     * @param GuildAuthenticatedListMatch|array|null $reqmatch Match filter (any subset
     *   of GuildAuthenticated fields) as an assoc-array; GuildAuthenticatedListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GuildAuthenticated[]|array A list of GuildAuthenticated items as assoc-arrays at
