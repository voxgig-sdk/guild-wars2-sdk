...
// GuildWars2 SDK Achievement entity
...
class AchievementEntity
{
     ...
     *
     * @param AchievementLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AchievementLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Achievement|array The loaded Achievement as an assoc-array at the
