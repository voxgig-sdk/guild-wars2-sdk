...
// GuildWars2 SDK WorldVsWorld entity
...
class WorldVsWorldEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WorldVsWorldEntity($this->_client, $opts);
    }

    /**
     * @param WorldVsWorld|array $args WorldVsWorld data (assoc-array) to store.
     */
    ...
    /**
     * @return WorldVsWorld|array The current WorldVsWorld data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WorldVsWorld fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WorldVsWorld fields).
     */
    ...
    /**
     * List WorldVsWorld items matching the given filter.
     *
     * @param WorldVsWorldListMatch|array|null $reqmatch Match filter (any subset
     *   of WorldVsWorld fields) as an assoc-array; WorldVsWorldListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WorldVsWorld[]|array A list of WorldVsWorld items as assoc-arrays at
