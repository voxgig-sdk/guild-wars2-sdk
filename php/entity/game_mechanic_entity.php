...
// GuildWars2 SDK GameMechanic entity
...
class GameMechanicEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GameMechanicEntity($this->_client, $opts);
    }

    /**
     * @param GameMechanic|array $args GameMechanic data (assoc-array) to store.
     */
    ...
    /**
     * @return GameMechanic|array The current GameMechanic data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GameMechanic fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GameMechanic fields).
     */
     ...
     *
     * @param GameMechanicListMatch|array|null $reqmatch Match filter (any subset
     *   of GameMechanic fields) as an assoc-array; GameMechanicListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GameMechanic[]|array A list of GameMechanic items as assoc-arrays at
