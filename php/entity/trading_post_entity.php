...
// GuildWars2 SDK TradingPost entity
...
class TradingPostEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TradingPostEntity($this->_client, $opts);
    }

    /**
     * @param TradingPost|array $args TradingPost data (assoc-array) to store.
     */
    ...
    /**
     * @return TradingPost|array The current TradingPost data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TradingPost fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TradingPost fields).
     */
     ...
     *
     * @param TradingPostLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TradingPostLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TradingPost|array The loaded TradingPost as an assoc-array at the
     ...
     *
     * @param TradingPostListMatch|array|null $reqmatch Match filter (any subset
     *   of TradingPost fields) as an assoc-array; TradingPostListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TradingPost[]|array A list of TradingPost items as assoc-arrays at
