// Command GuildWars2-mcp is an MCP server exposing the GuildWars2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GuildWars2_list  — list records of an entity
//	GuildWars2_load  — load a single record of an entity
//
